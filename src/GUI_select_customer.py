...
class SelectCustomerWindow(tk.Toplevel): 
    ...
    def __init__(self, app):
        ...
        self.rowconfigure(2, weight=0, minsize=styles.GUI_SC_row_minsize)
        self.columnconfigure(0, weight=4)
        self.columnconfigure(1, weight=1, minsize=styles.GUI_SC_row_minsize)
        
        ##############################-Set GUI Widgets-##############################
        
        #Customer list label
        self.customer_list_label = tk.Label(self, text="Customers", bg="#ffe4e1", anchor=tk.W)
        self.customer_list_label.grid(row=0, column=0, padx=styles.GUI_SC_padx, pady=(styles.GUI_SC_pady, 0), sticky=tk.SW)
        
        #Add customer to list button
        self.add_new_customer_button = tk.Button(self, text="+", command=self.app.GUI_create_customer)
        self.add_new_customer_button.grid(row=0, column=1, padx=styles.GUI_SC_padx, pady=(styles.GUI_SC_pady, 0), sticky=tk.NSEW)
        
        #Customer list
        self.customer_list = tk.Listbox(self, selectmode=tk.SINGLE)
        self.customer_list.grid(row=1, column=0, padx=styles.GUI_SC_padx, columnspan=2, sticky=tk.NSEW)
        ...
        self.add_custumer_button.grid(row=2, column=0, padx=styles.GUI_SC_padx, pady=styles.GUI_SC_pady, columnspan=2, sticky=tk.NSEW)
